...
Feel free to [open an issue](https://github.com/anthonylauzon/thankjs/issues/new),
or propose a [pull request](https://github.com/anthonylauzon/thankjs/pulls).
To prevent duplication, please look at [existing issues](https://github.com/anthonylauzon/thankjs/issues?q=is%3Aissue) before posting a new one.
...
```bash
git clone https://github.com/anthonylauzon/thankjs.git
```
...
```log
> thankjs@1.0.4 test ./npm-thankjs
> jest
